...
Mode.ACK         = Mode( 2, "ACK",       "AK", None,              "acknowledge")
Mode.REQUEST     = Mode( 3, "REQUEST",   "RS", None,              "request status")
# stopped        
Mode.STOP        = Mode( 4, "STOP",      "ST", ( 0,  0,  0,  0),  "stop")
# all wheels forward/backward
Mode.GO          = Mode( 5, "GO",        "GO", ( 1,  1 , 1 , 1),  "go forward or reverse")
# rotation (spin in place)
Mode.ROT_CW      = Mode( 6, "ROT_CW",    "RO", (-1,  1, -1,  1),  "rotate clockwise")
Mode.ROT_CCW     = Mode( 7, "ROT_CCW",   "RC", ( 1, -1,  1, -1),  "rotate counter-clockwise")
# crab movement (lateral strafe)  
Mode.CRAB_PORT   = Mode( 8, "CRAB_PORT", "CP", (-1,  1,  1, -1),  "crab to port")
Mode.CRAB_STBD   = Mode( 9, "CRAB_STBD", "CS", ( 1, -1, -1,  1),  "crab to starboard")
# diagonal movement  
Mode.DIA_PFWD    = Mode(10, "DIA_PFWD",  "DP", ( 0,  1,  1,  0),  "diagonal forward to port")
Mode.DIA_SFWD    = Mode(11, "DIA_SFWD",  "DS", ( 1,  0,  0,  1),  "diagonal forward to starboard")
Mode.DIA_PREV    = Mode(12, "DIA_PREV",  "DQ", (-1,  0,  0, -1),  "diagonal reverse to port")
Mode.DIA_SREV    = Mode(13, "DIA_SREV",  "DT", ( 0, -1, -1,  0),  "diagonal reverse to starboard")
Mode.DISABLE     = Mode(14, "DISABLE",   "DI", None,              "disable")
Mode.ERROR       = Mode(15, "ERROR",     "ER", None,              "error")
