...
class PID:
    ...
    def update(self, current_value):
        ...
        dt_us = utime.ticks_diff(current_time, self._last_time)
        ...
        if self._setpoint == 0.0:
            if isclose(current_value, 0.0, abs_tol=self._epsilon_rpm_for_stop):
                self._integral_error = 0.0
            elif current_value > 0: # Motor moving forward (positive RPM)
